$(document).ready(function () {
 ...
 var value = [];
  ...
  $(document).on('click' , '.operatorclick' , function(){
    operator =  $(this).text();
    screen += operator; 
    val.val(screen);
  ...
  $(document).on('click' , '.brktclick' , function(){
    brkt = $(this).text();
    screen += $(this).text();
    val.val(screen);
    if(brkt == "("){
  ...
  $(document).on('click' , '#equbtn' , function(){
    oprcheck = '';
   
    // console.log('brkt', brkt);
    ...
    if (val.value == '') {
      ...
      if (number.includes("(") && number.includes(")")) {
        ...
        chgtype = temparr[0];
        number.splice(brfirst, temp_length + 2, chgtype);
